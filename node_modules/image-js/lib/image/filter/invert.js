...
var _copyAlphaChannel = require('../internal/copyAlphaChannel');

var _copyAlphaChannel2 = _interopRequireDefault(_copyAlphaChannel);
...
function invert(options = {}) {
  ...
  if (this.bitDepth === 1) {
    ...
    if (this !== out) {
      (0, _copyAlphaChannel2.default)(this, out);
    }
  }
  return out;
}
