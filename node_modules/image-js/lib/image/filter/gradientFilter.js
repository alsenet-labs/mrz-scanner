...
function gradientFilter(options = {}) {
  ...
  switch (direction) {
    case 'x':
      ...
      return _convolution2.default.call(this, kernelX, {
        channels: channels,
        border: border,
        bitDepth
      });
    case 'y':
      ...
      return _convolution2.default.call(this, kernelY, {
        channels: channels,
        border: border,
        bitDepth
      });
    case 'xy':
      {
        if (!kernelX) throw new Error('kernelX option is missing');
        if (!kernelY) throw new Error('kernelY option is missing');
        const gX = _convolution2.default.call(this, kernelX, {
          channels: channels,
          border: border,
          bitDepth: 32
        });
        const gY = _convolution2.default.call(this, kernelY, {
          channels: channels,
          border: border,
          bitDepth: 32
        });
