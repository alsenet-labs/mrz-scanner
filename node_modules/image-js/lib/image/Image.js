...
var _bitMethods = require('./core/bitMethods');

var _bitMethods2 = _interopRequireDefault(_bitMethods);

var _checkProcessable = require('./core/checkProcessable');

var _checkProcessable2 = _interopRequireDefault(_checkProcessable);
...
var _getRGBAData = require('./core/getRGBAData');

var _getRGBAData2 = _interopRequireDefault(_getRGBAData);

var _kind = require('./core/kind');

var _kindNames = require('./core/kindNames');

var _load = require('./core/load');

var _load2 = _interopRequireDefault(_load);

var _valueMethods = require('./core/valueMethods');

var _valueMethods2 = _interopRequireDefault(_valueMethods);
...
var _getImageParameters = require('./internal/getImageParameters');

var _getImageParameters2 = _interopRequireDefault(_getImageParameters);
...
class Image {
  constructor(width, height, data, options) {
    ...
    const { kind = _kindNames.RGBA } = options;
  ...
  static createFrom(other, options) {
    const newOptions = (0, _getImageParameters2.default)(other);
...
(0, _valueMethods2.default)(Image);
(0, _bitMethods2.default)(Image);
(0, _export2.default)(Image);

Image.prototype.checkProcessable = _checkProcessable2.default;
Image.prototype.getRGBAData = _getRGBAData2.default;

Image.load = _load2.default;
Image.extendMethod = _extend.extendMethod;
Image.extendProperty = _extend.extendProperty;
(0, _extend3.default)(Image);