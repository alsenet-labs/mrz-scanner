...
class RoiManager {
  ...
  fromMaxima(options = {}) {
    ...
    let roiMap = _fromMaxima2.default.call(this._image, options);
  ...
  fromPoints(points, options = {}) {
    let opt = Object.assign({}, this._options, options);
    let roiMap = _fromPoints2.default.call(this._image, points, options);
    this._layers[opt.label] = new _RoiLayer2.default(roiMap, opt);
    return this;
  }
  ...
  /**
     ...
     */
  putMap(map, options = {}) {
    let roiMap = new _RoiMap2.default(this._image, map);
    let opt = Object.assign({}, this._options, options);
    this._layers[opt.label] = new _RoiLayer2.default(roiMap, opt);
    return this;
  }
  ...
  fromWaterShed(options = {}) {
    let opt = Object.assign({}, this._options, options);
    let roiMap = _fromWaterShed2.default.call(this._image, options);
    this._layers[opt.label] = new _RoiLayer2.default(roiMap, opt);
  }
  ...
  fromMask(mask, options = {}) {
    let opt = Object.assign({}, this._options, options);
    let roiMap = _fromMask2.default.call(this._image, mask, options);
    this._layers[opt.label] = new _RoiLayer2.default(roiMap, opt);
    return this;
  }
  ...
  fromMaskConnectedComponentLabelingAlgorithm(mask, options = {}) {
    let opt = Object.assign({}, this._options, options);
    let roiMap = _fromMaskConnectedComponentLabelingAlgorithm2.default.call(this._image, mask, options);
    this._layers[opt.label] = new _RoiLayer2.default(roiMap, opt);
    return this;
  }
  ...
  getMask(options = {}) {
    let mask = new _Image2.default(this._image.width, this._image.height, { kind: 'BINARY' });
    let masks = this.getMasks(options);
