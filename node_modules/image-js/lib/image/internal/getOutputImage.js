...
var _getImageParameters = require('./getImageParameters');
...
function getOutputImage(thisImage, options, newParameters, internalOptions = {}) {
  ...
  if (out === undefined) {
    if (internalOptions.copy) {
      ...
      return _Image2.default.createFrom(thisImage, newParameters);
    }
  } else {
    if (!_Image2.default.isImage(out)) {
      throw new TypeError('out must be an Image object');
    }
    const requirements = Object.assign((0, _getImageParameters2.default)(thisImage), newParameters);
