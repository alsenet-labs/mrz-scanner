...
function fromTwoMovingPoints(startingPoint1, startingPoint2, endingPoint1, endingPoint2) {
  ...
  const rotationMatrix = (0, _index.rotate)(angle, center.x, center.y);
  ...
  const scalingMatrix = (0, _index.scale)(scalingLevel, scalingLevel, center.x, center.y);
  return (0, _index.compose)([translationMatrix, scalingMatrix, rotationMatrix]);
}